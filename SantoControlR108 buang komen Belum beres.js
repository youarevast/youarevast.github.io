SANTO.OrbitControls = function(object, domElement){
	...
	this.mouseButtons = {LEFT: SANTO.MOUSE.ROTATE, MIDDLE: SANTO.MOUSE.DOLLY, RIGHT: SANTO.MOUSE.PAN};
	this.touches = {ONE: SANTO.TOUCH.ROTATE, TWO: SANTO.TOUCH.DOLLY_PAN};
	...
	var scale = 1;
	var panOffset = new SANTO.Vector3();
	var zoomChanged = false;

	var rotateStart = new SANTO.Vector2();
	var rotateEnd = new SANTO.Vector2();
	var rotateDelta = new SANTO.Vector2();

	var panStart = new SANTO.Vector2();
	var panEnd = new SANTO.Vector2();
	var panDelta = new SANTO.Vector2();

	var dollyStart = new SANTO.Vector2();
